...
<button data-hs-overlay="#hs-vertically-centered-modal" class="flex gap-2 border-2 px-4 py-1 rounded-md border-ternary  focus:bg-ternary duration-200 ease-in-out">
